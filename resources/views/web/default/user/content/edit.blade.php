    ...
    <div class="container n-padding-xs current-s">
        ...
        <div class="multi-steps">
            <div class="col-md-3 col-xs-12 col-sm-4 tab-con right-side">
                <ul>
                    <li class="active" cstep="1"><a href="javascript:void(0);"><i
                                class="upicon mdi mdi-library-video"></i><span>{{ trans('main.general') }}</span></a>
                    </li>
                    <li cstep="2"><a href="javascript:void(0);"><i
                                class="upicon mdi mdi-apps"></i><span>{{ trans('main.category') }}</span></a></li>
                    <li cstep="3"><a href="javascript:void(0);"><i
                                class="upicon mdi mdi-library-books"></i><span>{{ trans('main.extra_info') }}</span></a>
                    </li>
                    <li cstep="4"><a href="javascript:void(0);"><i
                                class="upicon mdi mdi-folder-image"></i><span>{{ trans('main.view') }}</span></a></li>
                    <li cstep="5"><a href="javascript:void(0);"><i
                                class="upicon mdi mdi-movie-open"></i><span>{{ trans('main.parts') }}</span></a></li>
                </ul>
            </div>
                ...
                <div class="steps" id="step1">
                    <form method="post" id="step-1-form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <textarea class="form-control editor-te editor-te-h"
                                    placeholder="You can import HTML..." name="content"
                ...
                <div class="steps dnone" id="step2">
                    <form method="post" id="step-2-form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <input type="text" data-role="tagsinput" placeholder="Press enter to save tag."
                                    name="tag" value="{{ $item->tag}}" class="form-control text-center">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label tab-con"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    ...
                                    @else
                                    <input type="number" name="price" onkeypress="validate(event)" value=""
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body no-absolute-content">
                                    ...
                                    <ul class="pre-course-title-container">
                                        ...
                                        <li>{{ $prec->title }}&nbsp;(VT-{{ $prec->id }})<i
                                                class="fa fa-times delete-course" cid="{{ $prec->id }}"></i></li>
                                        @endforeach
                                        @endif
                                    </ul>
                ...
                <div class="steps dnone" id="step4">
                    <form method="post" class="form-horizontal" id="step-4-form-meta">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group" style="display: flex">
                                    <button type="button" id="lfm_thumbnail" data-input="thumbnail"
                        ...
                        <ul id="accordion" class="accordion off-filters-li">
                            <li class="open edit-part-section dnone">
                                ...
                                <div class="submenu dblock">
                                    ...
                                    <form action="/user/content/part/edit/store/" id="step-5-form-edit-part"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7 tab-con">
                                                <div class="input-group asdf">
                                                    ...
                                                    <input type="text" name="upload_video" dir="ltr"
                                                        class="form-control">
                                                    <button type="button" id="lfm_upload_video"
                                                        data-input="upload_video" data-preview="holder"
                                                        class="btn btn-primary">
                                                        Choose
                                                    </button>
                                            ...
                                            <label
                                                class="control-label col-md-1 tab-con">{{ trans('main.sort') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label
                                                class="control-label col-md-2 tab-con">{{ trans('main.volume') }}</label>
                                            <div class="col-md-3 tab-con">
                                                <div class="input-group">
                                                    <input type="number" min="0" name="size"
                                                        class="form-control text-center">
                                                    <span
                                                        class="input-group-addon img-icon-s">{{ trans('main.mb') }}</span>
                                                </div>
                                            </div>
                                            <label
                                            ...
                                            <label
                                                class="control-label col-md-1 tab-con">{{ trans('main.free') }}</label>
                                            <div class="col-md-2 tab-con">
                                                <div
                                ...
                                <div class="submenu dblock">
                                    ...
                                    <form action="/user/content/part/store" id="step-5-form-new-part" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7 tab-con">
                                                ...
                                                <div class="input-group asdf">
                                                    ...
                                                    <input type="text" id="upload_video2" name="upload_video" dir="ltr"
                                                        class="form-control">
                                                    <button type="button" id="lfm_upload_video"
                                                        data-input="upload_video2" data-preview="holder"
                                                        class="btn btn-primary">
                                            ...
                                            <label
                                                class="control-label tab-con col-md-1">{{ trans('main.sort') }}</label>
                                            <div class="col-md-2 tab-con">
                                        ...
                                        <div class="form-group">
                                            <label
                                                class="control-label tab-con col-md-2">{{ trans('main.volume') }}</label>
                                            <div class="col-md-3 tab-con">
                                                <div class="input-group">
                                                    <input type="number" min="0" name="size"
                                            ...
                                            <label
                                                class="control-label tab-con col-md-1">{{ trans('main.free') }}</label>
                                            <div class="col-md-2 tab-con">
                                                <div class="switch switch-sm switch-primary pull-left">
                                                    <input type="hidden" value="0" name="free">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 tab-con">
                                                <button class="btn btn-custom tab-con pull-left" id="new-part"
